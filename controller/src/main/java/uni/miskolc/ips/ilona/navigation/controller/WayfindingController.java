...
public class WayfindingController {
    ...
    public @ResponseBody
    List<Zone> getNavigationPath(@RequestBody NavigationZoneRequest parameters) {
    ...
    public @ResponseBody
    List<Zone> getNavigationPathToPerson(@RequestBody NavigationPersonRequest parameters) {
        List<Zone> result = new ArrayList<>();
